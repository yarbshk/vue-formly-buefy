<template>
  <div class="block" v-bind="properties">
...
<script>
   ...
   */
  import BaseControlWrapperMixin from '@/mixins/base-control-wrapper'

  export default {
    name: 'vfbMultiBlockWrapper',
    mixins: [BaseControlWrapperMixin],
    computed: {
      properties () {
